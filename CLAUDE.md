...
The teaching approach below was arrived at by correction during Day 1. It works.
...
- A doc in `docs/days/day-NN-*.md` from [the template](docs/days/_TEMPLATE-day.md),
  all eleven sections filled.
- Durable material appended to `docs/concepts/*.md` — the per-day file is a journal,
  the concept files are what actually gets re-read.
